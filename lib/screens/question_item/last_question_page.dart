...
class LastQuestionPage extends StatefulWidget {
  const LastQuestionPage({super.key});
...
class _LastQuestionPageState extends State<LastQuestionPage> {
            ...
            children: [
              ...
              ProgressWidget(
                currentWidth: (MediaQuery.of(context).size.width * 0.78) *
                    ((currentQuestionIndex + 1) /
                        QuestionModel.questions3.length),
              ),
              const SizedBox(
                height: 50,
              ),
              ...
              Padding(
                ...
                child: QuestionWidget(
                    questionTitle:
                        QuestionModel.questions3[currentQuestionIndex].question,
              ...
              AnswersWidget(
                questionModel: QuestionModel.questions3[currentQuestionIndex],
  ...
  nextQuestion() {
    setState(() {
      ...
      if (currentQuestionIndex != QuestionModel.questions3.length - 1) {
        start = 15;
