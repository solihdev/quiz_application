            ...
            children: [
              ...
              ProgressWidget(
                currentWidth: (MediaQuery.of(context).size.width * 0.78) *
                    ((currentQuestionIndex + 1) /
                        QuestionModel.questions2.length),
              ),
              const SizedBox(
                height: 50,
              ),
              ...
              Padding(
                ...
                child: QuestionWidget(
                    questionTitle:
                        QuestionModel.questions2[currentQuestionIndex].question,
              ...
              AnswersWidget(
                questionModel: QuestionModel.questions2[currentQuestionIndex],
  ...
  nextQuestion() {
    setState(
      () {
        ...
        if (currentQuestionIndex != QuestionModel.questions2.length - 1) {
          start = 15;
